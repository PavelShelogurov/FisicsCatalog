...
public class DialogActitvity extends AppCompatActivity {
    ...
    public DialogActitvity(){
        this.formula = "formula";
        this.description = "description";
    }

    public DialogActitvity(String formula, String description) {
        this.formula = formula;
        this.description = description;
    }

    public DialogActitvity(int contentLayoutId, String formula, String description) {
